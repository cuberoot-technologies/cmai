<script>
	...
	import CarbonMarketsBanner from '../../components/carbonmarkets/CarbonMarketsBanner.svelte';
	import CarbonMarkets from '../../components/carbonmarkets/CarbonMarkets.svelte';
</script>
