<footer class=" bg-gray-900 ">
	<div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
		<div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
			<div>
				...
				<ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
					...
					<li>
						<a
							href="https://x.com/i/flow/login?redirect_after_login=%2Fofficial_cmai"
							rel="noreferrer"
							target="_blank"
							class="transition  text-teal-500 hover:text-teal-500/75"
						>
					...
					<li>
						<a
							href="https://www.linkedin.com/company/carbon-markets-association-of-india/"
							rel="noreferrer"
							target="_blank"
							class="transition  text-teal-500 hover:text-teal-500/75"
						>
							...
							<svg class="size-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
								<path 
								  d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.28c-.97 0-1.75-.79-1.75-1.75s.79-1.75 1.75-1.75c.97 0 1.75.79 1.75 1.75s-.78 1.75-1.75 1.75zm13.5 11.28h-3v-5.41c0-1.29-.03-2.96-1.8-2.96s-2.08 1.41-2.08 2.86v5.51h-3v-10h2.88v1.37h.04c.4-.75 1.38-1.54 2.84-1.54 3.04 0 3.61 2 3.61 4.59v5.58z"
								/>
							  </svg>
					...
					<li>
						...
						>
							...
							<svg class="size-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
								<path 
								  d="M23.5 6.6c-.3-1.1-1.2-1.9-2.3-2.1-2-.5-10.2-.5-10.2-.5s-8.2 0-10.2.5c-1.1.3-2 1-2.3 2.1-.5 2.1-.5 6.5-.5 6.5s0 4.4.5 6.5c.3 1.1 1.2 1.9 2.3 2.1 2 .5 10.2.5 10.2.5s8.2 0 10.2-.5c1.1-.3 2-1 2.3-2.1.5-2.1.5-6.5.5-6.5s0-4.4-.5-6.5zM9.8 15.3v-6.6l6.5 3.3-6.5 3.3z"
								/>
							  </svg>
		...
		<div class="mt-12 border-t border-gray-100 pt-6 dark:border-gray-800 ">
			<div class="text-center sm:flex sm:justify-between sm:text-left items-center">
				<form class="mt-6">
					<div class="relative max-w-xl">
						<label class="sr-only" for="email"> Email </label>

						<input
							class="w-full rounded-full border-gray-200  p-4 pe-32 text-sm font-medium dark:border-gray-700 bg-gray dark:text-white"
							id="email"
							type="email"
