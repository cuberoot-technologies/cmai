		...
		<div class="grid grid-cols-1 md:grid-cols-12">
			...
			<div class="space-y-9 md:col-span-9">
				...
				<div class="mx-auto bg-white shadow-md">
					...
					>
                    Carbon Project Consultancy and Sustainability Services including Carbon Neutral Services
					</h2>
					<div class="space-y-4">
						<!-- Event 1 -->
						<div class="    mb-0 border-b-2 border-dotted border-gray-200 p-3">
							<p class="text-xl text-gray-600">
								1.   Carbon Footprint & Assessment Studies
							</p>
						</div>
