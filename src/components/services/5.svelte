			...
			<div class="space-y-9 md:col-span-9">
				<div class="bg-white">
					...
					<p class="mb-4 text-xl text-gray-600">
						CMAI is committed to advancing informed climate action through in-depth knowledge papers
						and sectoral research reports. Our research focuses on practical pathways to
						decarbonization, enabling industries to navigate their Net Zero journeys while aligning
						with global climate commitments and market mechanisms.
					</p>

					<p class="mb-4 text-xl text-gray-600">
						We develop insightful, data-driven reports tailored to specific sectors, offering
						strategic guidance, policy insights, and actionable recommendations to accelerate
				...
				<div class="mx-auto bg-white shadow-md">
					...
					<div class="space-y-4">
						...
						<div class="   mb-0 border-b-2 border-dotted border-gray-200 p-3">
							<a
								href="https://drive.google.com/file/d/1V3n2NfBzQNEkke-RxFgI56Q1u1tnIwY2/view"
				...
				<p class="mb-4 text-xl text-gray-600">
					Through these reports, CMAI continues to serve as a thought leader, helping stakeholders
					across industries and sectors stay informed, prepared, and equipped for the evolving
