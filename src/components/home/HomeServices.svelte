...
<section class="bg-gray-50">
	<div class="mx-auto mb-10 max-w-screen-xl px-4 py-12">
		<div class="max-w-7xl items-end justify-between sm:flex sm:pe-6 lg:pe-8">
			<div class="max-w-xl">
				<h2 class="text-4xl font-bold tracking-tight text-sky-800 sm:text-5xl">Our Services</h2>

				<p class="mt-6 max-w-lg leading-relaxed text-gray-700">
					CMAI serves as a catalyst for action, actively working to facilitate the realization of
					low-carbon pathways worldwide.
				</p>
			</div>
		...
		<div class="-mx-6 mt-8 lg:col-span-2 lg:mx-0">
			<div bind:this={keenSliderElement} class="keen-slider">
				<div class="keen-slider__slide bg-white shadow-xs">
					<blockquote
						class="flex h-full flex-col justify-between bg-white p-6 shadow-xs transition-all duration-300 hover:border-gray-600 hover:shadow-[0px_0px_12px_2px_rgba(0,0,0,0.7)] sm:p-8 lg:p-10"
					>
						<div>
							<div class="flex gap-0.5 text-green-500">
								<img src="/icons/team-building.png" alt="" class="w-[90px]" />
							</div>
							<div class="mt-4">
								<p class="text-2xl font-bold text-black sm:text-3xl">Capacity Building/Skilling</p>
				...
				<div class="keen-slider__slide bg-white shadow-xs">
					...
					>
						<div>
							<div class="flex gap-0.5 text-green-500">
								<img src="/icons/legal.png" alt="" class="w-[90px]" />
							</div>
							<div class="mt-4">
								<p class="text-black-200 text-2xl font-bold sm:text-3xl">Policy Advocacy</p>
				...
				<div class="keen-slider__slide bg-white shadow-xs">
					...
					>
						<div>
							<div class="flex gap-0.5 text-green-500">
								<img src="/icons/consulting.png" alt="" class="w-[90px]" />
							</div>
							<div class="mt-4">
								<p class="text-black-200 text-2xl font-bold sm:text-3xl">
				...
				<div class="keen-slider__slide bg-white shadow-xs">
					...
					>
						<div>
							<div class="flex gap-0.5 text-green-500">
								<img src="/icons/climate-change.png" alt="" class="w-[90px]" />
							</div>
							<div class="mt-4">
								<p class="text-black-200 text-2xl font-bold sm:text-3xl">
				...
				<div class="keen-slider__slide bg-white shadow-xs">
					...
					>
						<div>
							<div class="flex gap-0.5 text-green-500">
								<img src="/icons/sustainable.png" alt="" class="w-[90px]" />
							</div>
							<div class="mt-4">
								<p class="text-black-200 text-2xl font-bold sm:text-3xl">
				...
				<div class="keen-slider__slide bg-white shadow-xs">
					...
					>
						<div>
							<div class="flex gap-0.5 text-green-500">
								<img src="/icons/information.png" alt="" class="w-[90px]" />
							</div>
							<div class="mt-4">
								<p class="text-black-200 text-2xl font-bold sm:text-3xl">Knowledge Report</p>
